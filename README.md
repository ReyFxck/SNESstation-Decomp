...
- **Matching:** 95.00%
- **Formal checkpoint:** **989/1,041** strict promoted matches
- **Recovered pending:** **0** (the V53 recovery set is fully formal)
- **Working checkpoint:** **989/1,041** with **52** entries remaining
...
relocations and target bytes are reproducibly verified. V74 applies that gate
to both SPC7110 RTC record functions and tracks every one of the 52 remaining
entries without counting the ownership map as matching evidence.
