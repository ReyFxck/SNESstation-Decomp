...
**309,848/720,620 code bytes** from 26 ELF objects, including original
`CPUEXEC.o`, `dma.o`, `ppu-short.o`, `SA1CPU.o` and eight runtime objects.
The remaining **410,772 code bytes** still pass through generated `.incbin`
