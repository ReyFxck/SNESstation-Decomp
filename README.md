...
**125,540/720,620 code bytes** coming from seven ELF object inputs placed by the
...
and historical Newlib `qsort.o` with its self-call relocation.
The remaining **595,080 bytes** still use the generated
