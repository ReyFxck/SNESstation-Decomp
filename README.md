...
**671,004/720,620 code bytes (93.11%)** from 121 ELF inputs, including
...
original zlib objects, historical PS2LIB runtime members and EE GCC 3.2.2
`libgcc.a` members. The remaining **49,616 code bytes**
