 ...
 * SNESticle source tree.  CDVD_GetSize and CDVD_GETSIZE=0x08 survive in the
 * PGEN copy of the same libcdvd family.
 *
 * Keep names, declaration order and expression shapes historical here.
 */
#include "cdvd_legacy_compat.h"
