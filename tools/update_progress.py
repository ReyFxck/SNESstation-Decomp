...
| Recovered exact results still pending formal promotion | {project_status.recovered_pending:,} | V53 recovery set is fully formal; V73 PS2-I/O proofs included; working checkpoint **{project_status.working_checkpoint:,}/{VALIDATED_TARGETS:,} ({project_status.working_percent:.2f}%)** |
...
| Recovered exact results still pending promotion | **{project_status.recovered_pending:,}** | All recovered V53 results are formal; V73 added two independently reproduced PS2-I/O matches. |
