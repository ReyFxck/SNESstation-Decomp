...
class DataBackingTests(unittest.TestCase):
    ...
    def test_counts_keep_stage3f_open(self):
        ...
        for key, expected in {"contracts_total": 1265, "section_backed_addresses": 886,
                              "unbacked_addresses": 379, "reused_sections": 66, "new_sections": 109,
                              "new_backing_bytes": 69768, "new_zero_fill_bytes": 0,
                              "total_backing_bytes": 300286}.items():
    ...
    def test_interior_aliases_never_claim_extent(self):
        ...
        self.assertEqual(len(interior), 181)
    ...
    def test_new_assembly_has_no_object_sizes_or_globals(self):
        ...
        self.assertEqual(text.count(".incbin"), 109)
    ...
    def test_rebinding_assigns_inside_output_section(self):
        ...
        self.assertEqual(text.count(" = . + "), 886)
        self.assertEqual(text.count("KEEP(*("), 175)
    ...
    def test_probe_declares_three_address_relocations_per_alias(self):
        ...
        self.assertEqual(text.count(".word "), 886)
        self.assertEqual(text.count("%hi("), 886)
        self.assertEqual(text.count("%lo("), 886)
        self.assertNotIn(".globl", text)
