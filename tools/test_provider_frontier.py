...
class ProviderFrontierTests(unittest.TestCase):
    ...
    def test_frozen_repository_manifest_closes_exact_v87_frontier(self) -> None:
        ...
        self.assertEqual(
            {
                "frontier_total": 251,
                "absolute_anchors": 181,
                "semantic_aliases": 9,
                "compatibility_storage_symbols": 44,
                "runtime_shims": 17,
                "compatibility_storage_bytes": 185694,
            },
            summarize(rows),
        )
    ...
    def test_every_row_has_one_resolution_mechanism(self) -> None:
        ...
        self.assertEqual(251, len(set().union(*by_kind.values())))
    ...
    def test_frontier_drift_is_rejected(self) -> None:
        ...
        with self.assertRaisesRegex(FrontierError, "251"):
    ...
    def test_input_frontier_must_be_exact(self) -> None:
        ...
        self.assertEqual(251, len(verify_input_frontier(symbols, rows)))
