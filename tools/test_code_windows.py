...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(492824, result["direct_object_bytes"])
        self.assertEqual(26, result["direct_candidate_object_inputs"])
        self.assertEqual(227796, result["incbin_payload_bytes"])
