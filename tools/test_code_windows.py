...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(296116, result["direct_object_bytes"])
        self.assertEqual(11, result["direct_candidate_object_inputs"])
        self.assertEqual(424504, result["incbin_payload_bytes"])
