...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(681612, result["direct_object_bytes"])
        self.assertEqual(126, result["direct_candidate_object_inputs"])
        self.assertEqual(39008, result["incbin_payload_bytes"])
