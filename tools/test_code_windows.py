...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(133148, result["direct_object_bytes"])
        self.assertEqual(7, result["direct_candidate_object_inputs"])
        self.assertEqual(587472, result["incbin_payload_bytes"])
