...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(366536, result["direct_object_bytes"])
        self.assertEqual(22, result["direct_candidate_object_inputs"])
        self.assertEqual(354084, result["incbin_payload_bytes"])
