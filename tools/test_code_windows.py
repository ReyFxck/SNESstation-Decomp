...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(126260, result["direct_object_bytes"])
        self.assertEqual(6, result["direct_candidate_object_inputs"])
        self.assertEqual(594360, result["incbin_payload_bytes"])
