...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(123132, result["direct_object_bytes"])
        self.assertEqual(1, result["direct_candidate_object_inputs"])
        self.assertEqual(597488, result["incbin_payload_bytes"])
