...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(671004, result["direct_object_bytes"])
        self.assertEqual(116, result["direct_candidate_object_inputs"])
        self.assertEqual(49616, result["incbin_payload_bytes"])
