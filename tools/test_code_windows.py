...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(277536, result["direct_object_bytes"])
        self.assertEqual(10, result["direct_candidate_object_inputs"])
        self.assertEqual(443084, result["incbin_payload_bytes"])
