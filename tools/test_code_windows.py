...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(309848, result["direct_object_bytes"])
        self.assertEqual(21, result["direct_candidate_object_inputs"])
        self.assertEqual(410772, result["incbin_payload_bytes"])
