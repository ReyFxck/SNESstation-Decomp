...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(305436, result["direct_object_bytes"])
        self.assertEqual(12, result["direct_candidate_object_inputs"])
        self.assertEqual(415184, result["incbin_payload_bytes"])
