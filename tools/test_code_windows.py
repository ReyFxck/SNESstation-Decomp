...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(209976, result["direct_object_bytes"])
        self.assertEqual(9, result["direct_candidate_object_inputs"])
        self.assertEqual(510644, result["incbin_payload_bytes"])
