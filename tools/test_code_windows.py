...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(491796, result["direct_object_bytes"])
        self.assertEqual(24, result["direct_candidate_object_inputs"])
        self.assertEqual(228824, result["incbin_payload_bytes"])
