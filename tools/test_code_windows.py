...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(445612, result["direct_object_bytes"])
        self.assertEqual(23, result["direct_candidate_object_inputs"])
        self.assertEqual(275008, result["incbin_payload_bytes"])
