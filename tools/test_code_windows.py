...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(562636, result["direct_object_bytes"])
        self.assertEqual(37, result["direct_candidate_object_inputs"])
        self.assertEqual(157984, result["incbin_payload_bytes"])
