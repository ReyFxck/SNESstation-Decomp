...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(632936, result["direct_object_bytes"])
        self.assertEqual(55, result["direct_candidate_object_inputs"])
        self.assertEqual(87684, result["incbin_payload_bytes"])
