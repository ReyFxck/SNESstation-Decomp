...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(531248, result["direct_object_bytes"])
        self.assertEqual(31, result["direct_candidate_object_inputs"])
        self.assertEqual(189372, result["incbin_payload_bytes"])
