...
class CodeWindowsTests(unittest.TestCase):
    ...
    def test_all_code_windows_are_exact(self):
        ...
        self.assertEqual(497020, result["direct_object_bytes"])
        self.assertEqual(27, result["direct_candidate_object_inputs"])
        self.assertEqual(223600, result["incbin_payload_bytes"])
