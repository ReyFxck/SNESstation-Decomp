#!/usr/bin/env python3
"""Generate the V78 address-level map for the 44 unmatched functions."""
...
OUTPUT = ROOT / "analysis" / "matching" / "hunt1041-v78-frontier-map-44.tsv"
EXPECTED_FRONTIER = 44
MATCHING_GATE = (
...
PACKETS = (
    ...
    Packet(
        (
            0x0010C340, 0x0010C6F8, 0x0010CFA4, 0x0010D7DC,
        ),
        "historical-source",
        "c4-core",
