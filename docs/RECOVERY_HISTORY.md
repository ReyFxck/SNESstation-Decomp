...
| Public historical data | Pinned Snes9x, zlib and PS2 runtime source | Tables, constants, strings, vtables and typed data intervals | 49 exact intervals covering 810,542 bytes; 695,316 bytes rebuilt from public source | `make historical-data` |
...
| Whole-image code | Historical objects, recovered source and labelled exact assembly | Complete 64 KiB code regions | Windows 1–6 and 12–50 exact; 0 and 7–11 remain | `make code-windows` |
| Final executable | Historical link and SJCRUNCH2 packing | Exact object order, final relocations, linker script and packed container | In progress; 45/51 image windows exact | `make reproduce` |
