...
> Frozen checkpoint. V76 subsequently promoted `C4SprDisintegrate`, V77
> promoted `C4DrawWireFrame`, and V78 promoted `C4BitPlaneWave`; use the
> current 44-entry frontier linked from the project status documentation.
