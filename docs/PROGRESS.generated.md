...
|---|---:|---:|
| Matching | 994 | **95.49%** |
| Recovered exact results still pending formal promotion | 0 | V53 recovery set is fully formal; V75 C4 float/math proofs included; working checkpoint **994/1,041 (95.49%)** |
