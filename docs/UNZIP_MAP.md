...
The final source cleanup removes the provisional `g_unz_ops_recovered`
callback table and `g_zip_io_recovered` aggregate. The recovered code now calls the target's
...
and legacy-method workspaces. This closes the named-data layout claim;
