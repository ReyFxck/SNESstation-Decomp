...
| `link_identity/` | Stage-3 unpacked-layout oracle and link evidence without private bytes |
...
- `link_identity/` — hash-only unpacked layout and later whole-program link evidence.
