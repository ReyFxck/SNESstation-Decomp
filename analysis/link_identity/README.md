...
- `link_contracts.tsv` classifies every one of the 1,594 live post-refactor
  externals: 1,273 absolute target-address anchors, 63 semantic text aliases
  and 258 explicit provider blockers.
...
- `provider_frontier_closure.tsv` classifies all 248 live names left after the
  private providers into 181 target-address anchors, nine recovered-text aliases, 41 compatibility
...
bytes and reduces the partial-link frontier from 258 to 248. No generated
...
links them after the private providers and proves **248 -> 0** undefined
